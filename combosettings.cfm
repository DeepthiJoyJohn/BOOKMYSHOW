<html>
	<form id="form" name="form" method="post" action="" enctype="multipart/form-data">
		...
		<cfinvoke component="BOOKMYSHOW.Components.adminsettings" method="combos" returnVariable="combos">		  	 
		<body>
			<header id="header">			
				<div class="d-flex flex-column">
					...
					<nav id="navbar" class="nav-menu navbar">
						<ul>			          	
							<li><a href="index.cfm" class="nav-link scrollto"><i class="bx bx-log-out"></i> <span>Combos</span></a></li>		          
						</ul>
						<ul>			          	
										...
										<div class="row justify-content-center">			            
											<div>
												<table class="table">
													...
													<cfloop index="i" from="1" to="#combos.RecordCount#">
